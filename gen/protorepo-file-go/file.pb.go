...
var file_file_proto_rawDesc = []byte{
	...
	,
...
var file_file_proto_depIdxs = []int32{
	0, // 0: file.api.FileCenter.UpdateFile:input_type -> file.api.UpdateFileRequest
	2, // 1: file.api.FileCenter.GetKV:input_type -> file.api.GetKVRequest
	4, // 2: file.api.FileCenter.SetKV:input_type -> file.api.SetKVRequest
	1, // 3: file.api.FileCenter.UpdateFile:output_type -> file.api.UpdateFileResponse
	3, // 4: file.api.FileCenter.GetKV:output_type -> file.api.GetKVResponse
	5, // 5: file.api.FileCenter.SetKV:output_type -> share.api.Empty
...
func (c *fileCenterClient) UpdateFile(ctx context.Context, in *UpdateFileRequest, opts ...grpc.CallOption) (*UpdateFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/file.api.FileCenter/UpdateFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileCenterClient) GetKV(ctx context.Context, in *GetKVRequest, opts ...grpc.CallOption) (*GetKVResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/file.api.FileCenter/GetKV", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileCenterClient) SetKV(ctx context.Context, in *SetKVRequest, opts ...grpc.CallOption) (*protorepo_share_go.Empty, error) {
	out := new(protorepo_share_go.Empty)
	err := c.cc.Invoke(ctx, "/file.api.FileCenter/SetKV", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedFileCenterServer) SetKV(context.Context, *SetKVRequest) (*protorepo_share_go.Empty, error) {
...
func _FileCenter_UpdateFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/file.api.FileCenter/UpdateFile",
	}
...
func _FileCenter_GetKV_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/file.api.FileCenter/GetKV",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileCenter_SetKV_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/file.api.FileCenter/SetKV",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _FileCenter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "file.api.FileCenter",
